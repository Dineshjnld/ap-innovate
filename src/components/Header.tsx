  ...
  return (
    <header className="fixed inset-x-0 top-0 z-[100]">
      <div className="gradient-navy border-b border-navy-light">
        <div className="mx-auto grid h-20 max-w-full grid-cols-3 items-center px-4 sm:px-6 lg:px-8">
          <button
            type="button"
      ...
      <div className="border-b border-navy-light bg-navy/95 backdrop-blur-sm">
        <div className="mx-auto flex h-12 max-w-full items-center gap-2 px-4 sm:px-6 lg:px-8">
          <Button
            type="button"
            variant="outline"
            size="sm"
